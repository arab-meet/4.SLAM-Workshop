...
\[
\mu = \frac{5 + 5 + 10 + 10 + 10}{5} = \frac{40}{5} = 8 \text{ cents}
\]
...
\[
E[w] = \frac{79.8 + 80.0 + 80.1 + 79.8 + 80.2}{5} = 79.98 \text{ kg}
\]
...
\[
\sigma^2 = \frac{(1.89 - 1.914)^2 + \dots + (1.85 - 1.914)^2}{5}
\]
